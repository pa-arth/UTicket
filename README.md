...
| **Settings Screen** | Profile management, role switching between Buyer/Seller, password change, notification preferences, sign out, and profile image update | Alpha | Beta | None | Paarth (65%), Naveed (40%)|
...
| **Explore Tickets (Buyer Flow)** | Browse all available ticket listings. Includes search functionality to filter by event name, seat details, price, date, and time. Real-time data fetching from Firestore | Alpha | Alpha | None | Zaviyan (40%), Paarth (30%), Naveed (30%) |
